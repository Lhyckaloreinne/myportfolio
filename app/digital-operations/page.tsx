      ...
      <section className="mt-24 border-t border-border pt-16 md:mt-32 md:pt-20">
        <div className="grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <p className="mt-5 mb-15 max-w-[400px] text-sm leading-relaxed text-muted">
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted sm:text-base">
                    I bring structure to information, schedules, files, and recurring
                    tasks so they are easier to manage and less likely to get
                    overlooked.
                  </p>
                </div>
            ...
            <div className="border-b border-border py-8 md:py-9">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted sm:text-base">
                    I pay attention to details, deadlines, follow-ups, and priorities
                    that can easily be overlooked when responsibilities compete for
                    attention.
                  </p>
                </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted">
                    I help keep the work behind the scenes moving so you can give
                    more attention to the responsibilities that matter most.
                  </p>
                </div>
