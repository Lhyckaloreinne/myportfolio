        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 lg:gap-5 xl:gap-6">
          {specializations.map((item, index) => (
            <motion.div
              ...
              className="group flex flex-col justify-between h-full rounded-2xl border border-[#E6DAC6] bg-[#FBF8F1] p-5 sm:p-6 lg:p-5 xl:p-6 transition-all duration-500 hover:border-[#C8A35B]/70 hover:shadow-xs"
            >
              <div>
                ...
                <div className="flex items-center justify-between text-[10px] font-semibold uppercase tracking-[0.3em] text-[#C8A35B] mb-2">
                  ...
                  <span className="font-serif text-lg font-light text-[#C8A35B]/60">{item.number}</span>
                </div>

                {/* Title */}
                <h3 className="font-serif text-lg font-normal tracking-tight text-[#1A1714] sm:text-xl lg:text-lg xl:text-xl leading-snug">
                  {item.title}
                </h3>
              ...
              <div className="mt-6 pt-4 border-t border-[#E6DAC6]">
                <Link
                  href={item.href}
                  className="group/link inline-flex items-center justify-between w-full text-[11px] font-semibold uppercase tracking-[0.25em] text-[#1A1714] transition-colors hover:text-[#C8A35B]"
                >
                  <span>Explore</span>
                  <div className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-[#C8A35B]/50 bg-[#F6F2E9] text-[#1A1714] transition-all duration-300 group-hover/link:border-[#C8A35B] group-hover/link:bg-[#C8A35B] group-hover/link:text-white">
